...
<!--  js  -->
<script type="text/javascript" src="<?=$NO_IS_SUBDIR?>/admin/resource/js/admin.js?c=<?=$STATIC_ADMIN_JS_MODIFY_DATE?>"
    defer></script>
<script type="text/javascript" src="<?=$NO_IS_SUBDIR?>/admin/resource/js/script.js?c=<?=$STATIC_ADMIN_JS_MODIFY_DATE?>"
    defer></script>

<script type="text/javascript" src="<?=$NO_IS_SUBDIR?>/admin/resource/js/form.js?c=<?=$STATIC_ADMIN_JS_MODIFY_DATE?>"
    defer></script>
<script type="text/javascript" src="<?=$NO_IS_SUBDIR?>/admin/resource/js/theme.js?c=<?=$STATIC_ADMIN_JS_MODIFY_DATE?>"
    defer></script>
...
<script type="module" src="<?=$NO_IS_SUBDIR?>/admin/resource/js/app.js?c=<?=$STATIC_ADMIN_JS_MODIFY_DATE?>" defer>
</script>