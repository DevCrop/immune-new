...
<main>
    ...
    <?php
    $banners = getBannersByBranch('gangseo', 4);
                        ...
                        <section class="no-cancer-intro neuro no-pd-24--t no-pd-48--b">
                            ...
                            <div class="no-container-sm">
                                ...
                                <div class="cancer-case-wrap fade-up no-mg-80--t">
                                    ...
                                    <strong class="no-heading-sm --tac no-mg-40--b">이미 <b class="navy">50,000명의
                                            환자</b>들이<br> 일상을 되찾았습니다.</strong>
                                    ...
                                    <span class="source no-body-sm fw300 --tac no-mg-24--t" <?= $aos_fade ?>>2024. 11.
                                        06 기준, 전지점 조사결과</span>
                                        ...
                                        <li class="swiper-slide">
                                            ...
                                            <a href="https://www.youtube.com/watch?v=LiBjhAbLUa4" target="_blank">
                                                ...
                                                <div class="f-wrap no-mg-16--t">
                                                    ...
                                                    <h3 class="no-heading-sm no-mg-8--b">갑작스러운 자궁근종, 심한 가스통증도 사라졌어요!
                                                    </h3>
                                                ...
                                                <div class="txt no-mg-8--t">
                                                    ...
                                                    <p class="no-mg-8--t no-body-md fw300">갑작스러운 자궁근종 수술 후 면력에서 회복관리를
                                                        받았습니다. 정성 가득한 면역 식단과 원장님의 다양한 치료로 극심한 가스통증이 사라졌어요. 세심한 치료와 배려에
                                                        진심으로 감사드립니다.</p>
                        ...
                        <section class="no-neuro-doctor no-pd-48--y">
                            ...
                            <div class="no-container-sm">
                                ...
                                <div class="txt no-mg-16--t --tac fade-up">
                                    ...
                                    <h2 class="no-heading-sm no-mg-8--t">임지성</h2>
                        ...
                        <section class="no-cancer-sub-system bg no-pd-48--y">
                            ...
                            <div class="no-container-sm">
                                ...
                                <hgroup class="--tac fade-up no-mg-32--b">
                                    ...
                                    <p class="no-body-lg fw300">회복 중인 몸에 맞춘 식단은<br> <b class="fw600 navy">치료의 연장이자 재활의
                                            시작</b>입니다.</p>
                                ...
                                <strong class="no-body-lg fw300 no-mg-24--t fade-up --tac">면력 재활센터는 수술 후·사고 후<br> 몸에 맞춘
                                    맞춤 식단으로<br> <b class="fw600 navy">회복에 최적화된 식사를 제공합니다.</b></strong>
